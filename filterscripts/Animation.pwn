...
{
	print("\n----------------------------------");
	print("    Animation Scripts Unload     ");
	print("----------------------------------\n");
	return 1;
}
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	if (strcmp("/animhelp", cmdtext, true) == 0)
	{
	    ...
	    SendClientMessage(playerid,COLOR_ORANGE,"==============================Animation List================================");
		SendClientMessage(playerid,COLOR_ORANGE,"============================================================================");
        ...
        SendClientMessage(playerid,COLOR_YELLOW2,"/chat, /fucku, /taichi, /chairsit, /relax, /bat1, /bat2, /bat3, /bat4, /bat5, /nod, /cry1, /cry2, /chant, /carsmoke, /aims");
        ...
        SendClientMessage(playerid,COLOR_YELLOW2,"/exhausted, /ghand1, /ghand2, /ghand3, /ghand4, /ghand5/akick, /box, /cockgun");
    ...
    else if(strcmp(cmdtext, "/aims", true) == 0)
	{
